...
def demografía_y_firmas(estado):
    ...
    if estado.poder_de_compra_medio < estado.poder_de_compra_referencia:
        ...
        nueva_empresa.precio = estado.precio_medio * rand.uniform(0.85, 1.15)
        ...
        nueva_empresa.calidad = max(0.0, min(estado.calidad_medio * rand.uniform(0.9, 1.1), 1.0))
        nueva_empresa.satisfacción = max(0.0, min(estado.satisfacción_medio * rand.uniform(0.9, 1.1), 1.0))
