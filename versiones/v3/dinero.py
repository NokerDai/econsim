def emisión_monetaria(estado):
    ...
    if estado.config.tasa_emisión != 0:
        ...
        if config.mantenimiento_M0 == "agentes":
        ...
        elif config.mantenimiento_M0 == "ventas":
            ...
            tasa = max(1, (objetivo / M0_actual + estado.config.mantenimiento_M0_suavizado) / (estado.config.mantenimiento_M0_suavizado + 1))
